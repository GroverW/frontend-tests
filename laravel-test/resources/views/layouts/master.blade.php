  ...
  <div class="container">
    <nav class="relative md:fixed flex justify-center items-center w-screen bg-gray-800  h-20 md:h-32">
      <ul class="hidden md:flex flex-row">
        ...
        <li class="mr-48"><a class="block {{ Request::path() == 'menu' ? 'text-red-600' : 'text-gray-500 hover:text-gray-300 hover:bg-gray-900' }} uppercase w-24 text-center leading-4 p-2 rounded" href="">Menu</a></li>
